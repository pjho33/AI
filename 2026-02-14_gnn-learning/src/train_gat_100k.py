"""
GAT 모델로 100k 학습
Attention mechanism으로 더 강력한 학습
"""
...
def train_gat_model(graphs, epochs=50, batch_size=128):
    """GAT 모델 학습"""
    ...
    for epoch in range(epochs):
        ...
        if val_loss < best_val_loss:
            ...
            patience_counter = 0
            torch.save(model.state_dict(), 'data/best_gat_100k.pt')
        else:
            patience_counter += 1
    ...
    model.load_state_dict(torch.load('data/best_gat_100k.pt'))
    model.eval()
    ...
    print(f"모델 저장: data/best_gat_100k.pt")
...
def main():
    ...
    # GAT 학습
    model, test_acc = train_gat_model(graphs, epochs=50, batch_size=128)
